...
import java.util.*;
class Printer{
    synchronized void printDocuments(int numOfCopies,String docName){// to mark this as synchronized as when our thread executes this method, it will acquire an intrinsic lock, when the lock is acquired, no other thread can accept the printDocuments....
